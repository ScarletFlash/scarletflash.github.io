...
} from './design-system-color-palette/design-system-color-palette-item/design-system-color-palette-item.component';
import {
  DesignSystemColorPaletteComponent,
} from './design-system-color-palette/design-system-color-palette.component';
